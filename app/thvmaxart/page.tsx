/*
 * CASE STUDY — THVMAXART
 *
 * To rename this route, rename the parent folder only:
 *   app/thvmaxart  →  app/<new-slug>
 *
 * To add images:
 *   1. Drop assets into  public/case-studies/thvmaxart/
...
export const metadata: Metadata = {
  title: 'THVMAXART — Case Study | THVMAX',
  description: 'Brand and campaign design for Thvmax Portfolio, 2023.',
  robots: {
    index: false,
    follow: true,
  },
...
const META = [
  { label: 'Client',       value: 'Thvmax Portfolio' },
...
export default function ThvmaxartCaseStudy() {
  return (
    <main className={styles.main}>
      ...
      <section className={styles.hero}>
        {/*
          ...
          <Image
            src="/case-studies/thvmaxart/hero.jpg"
            alt="THVMAXART — Hero Campaign Visual"
            fill
        ...
        */}
        <div className={styles.galleryGrid}>
          ...
          <div className={styles.galleryLandscape}>
            {/* <Image src="/case-studies/thvmaxart/01.jpg" alt="Key Visual — Landscape" fill style={{ objectFit: 'cover' }} /> */}
          ...
          <div className={styles.galleryPortrait}>
            {/* <Image src="/case-studies/thvmaxart/02.jpg" alt="Key Visual — Portrait" fill style={{ objectFit: 'cover' }} /> */}
            <div className={styles.galleryPlaceholder}>
          ...
          <div className={styles.gallerySquare1}>
            {/* <Image src="/case-studies/thvmaxart/03.jpg" alt="Social Asset 01" fill style={{ objectFit: 'cover' }} /> */}
            <div className={styles.galleryPlaceholder}>
          ...
          <div className={styles.gallerySquare2}>
            {/* <Image src="/case-studies/thvmaxart/04.jpg" alt="Social Asset 02" fill style={{ objectFit: 'cover' }} /> */}
            <div className={styles.galleryPlaceholder}>
          ...
          <div className={styles.galleryWide}>
            {/* <Image src="/case-studies/thvmaxart/05.jpg" alt="OOH / Billboard" fill style={{ objectFit: 'cover' }} /> */}
            <div className={styles.galleryPlaceholder}>
